...
import com.example.dogadoptionapp.Message
...
import com.example.dogadoptionapp.Util.DATA_MESSAGES
import com.example.dogadoptionapp.adapters.MessagesAdapter
                ...
                p0.children.forEach { value ->
                    ...
                    if(!key.equals(userId)) {
                        ...
                        topPhotoIV.setOnClickListener {
                            startActivity(UserInformationActivity.newIntent(this@ChatActivity, otherUserId))
                        }
                    }
                }
            }
